...
********************************| Description: |********************************************
*                                                                                          *
*           This class stores the episodes, all the states that come in between            *
*           the initial state and the terminal state. This file is later used              *
*           by the agent for learning by experience, called "exploration."                 *
*                                                                                          *  
********************************************************************************************
"""
