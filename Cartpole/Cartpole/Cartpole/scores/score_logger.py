...
* Last Modified:       Tues Nov 18th 12:21:21 2024
--------------------------------------------------------------------------------
Description: This python script will 
- log the scores of the agent and save them to a csv file and a png file. 
- The script will also log if the agent has solved the problem and save the number of runs it took to solve the problem.
--------------------------------------------------------------------------------
"""
