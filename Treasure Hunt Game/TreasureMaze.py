...
-------------------------------------------------------------------------------------------------------------------------
Description: This script is responsible for defining the environment, which includes a maze object defined as a matrix.
It also is responsible for the pirate, the target, and the free cells. The agent can move in one of four directions.
-------------------------------------------------------------------------------------------------------------------------
"""
